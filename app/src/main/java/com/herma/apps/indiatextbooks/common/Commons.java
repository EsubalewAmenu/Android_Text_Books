...
import com.herma.apps.indiatextbooks.ChaptersActivity;
import com.herma.apps.indiatextbooks.R;
import com.herma.apps.indiatextbooks.ReadActivity;
                ...
                progressBar.show();
                    if (serviceType.equals("d")) {
                        try {
                            ...
                            String downloadUrl = WEBSITE + "/consol/chap?cnt=pak&name=";
